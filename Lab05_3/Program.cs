...
namespace Lab05_3
{
    public class TramvayStop
    {
        ...
        public static void EditDate(List<Hour> Date)
        {
            Console.Clear();
            Hour.ShowTable(Date);
    ...
    public class Hour : TramvayStop
    {
        ...
        public static void LongCom(List<Hour> Date)
        {
            int IndexMax = 0;
        ...
        public static int AllNumPass(List<Hour> Date)
        {
            int ANP = 0;
            foreach (Hour hour in Date)
            {
